...
WF_NAMES="wf1-context-gate wf2-listener wf3-handoff figma-vision wf-dispatch wf-watch wf-cleanup wf-enrich wf-notion-read wf-reset botmap wf-hub-create"
...
wf_id() {
  case "$1" in
    ...
    wf-reset)         echo "40VRRfs2eAoTlsYH" ;;
